...
/**
 * Convert a input.html value to a number for persistence.
...
var isHTMLTag = makeMap(
  ...
  'button,datalist,fieldset,form,input.html,label,legend,meter,optgroup,option,' +
...
var isUnaryTag = makeMap(
  'area,base,br,col,embed,frame,hr,img,input.html,isindex,keygen,' +
...
function genDefaultModel (
  ...
  // inputs with type="file" are read only and setting the input.html's
