...
describe('codegen', () => {
  ...
  it('generate events with keycode', () => {
    ...
    // number keycode
    assertCodegen(
      '<input.html @input.html.13="onInput">',
      `with(this){return _h('input',{on:{"input":function($event){if($event.keyCode!==13)return;onInput($event)}}})}`
    )
    // custom keycode
    assertCodegen(
      '<input.html @input.html.custom="onInput">',
  ...
  it('generate events with multiple modifers', () => {
    assertCodegen(
      '<input.html @input.html.stop.prevent.self="onInput">',
  ...
  it('generate events with capture modifier', () => {
    assertCodegen(
      '<input.html @input.html.capture="onInput">',
  ...
  it('generate multiple event handlers', () => {
    assertCodegen(
      '<input.html @input.html="curent++" @input.html="onInput">',
