...
describe('parser', () => {
  ...
  it('attribute with v-bind', () => {
    const ast = parse('<input.html type="text" name="field1" :value="msg">', baseOptions)
  ...
  it('attribute with v-on', () => {
    const ast = parse('<input.html type="text" name="field1" :value="msg" @input.html="onInput">', baseOptions)
    expect(ast.events.input.value).toBe('onInput')
  })

  it('attribute with directive', () => {
    const ast = parse('<input.html type="text" name="field1" :value="msg" v-validate:field1="required">', baseOptions)
  ...
  it('attribute with modifiered directive', () => {
    const ast = parse('<input.html type="text" name="field1" :value="msg" v-validate.on.off>', baseOptions)
  ...
  it('literal attribute', () => {
    // basic
    const ast1 = parse('<input.html type="text" name="field1" value="hello world">', baseOptions)
    ...
    // interpolation warning
    parse('<input.html type="text" name="field1" value="{{msg}}">', baseOptions)
    expect('Interpolation inside attributes has been deprecated').toHaveBeenWarned()
  })
  ...
  it('not specified mustUseProp', () => {
    ...
    const ast = parse('<input.html type="text" name="field1" :value="msg">', options)
