...
describe('SSR: renderToString', () => {
  ...
  it('unary tags', done => {
    renderVmWithOptions({
      template: '<input.html value="123">'
    }, result => {
      expect(result).toContain('<input.html value="123" server-rendered="true">')
      done()
    })
  })
  ...
  it('v-bind object', done => {
    renderVmWithOptions({
      ...
      template: '<input.html v-bind="test">'
    }, result => {
      expect(result).toContain('<input.html id="a" server-rendered="true" value="c" class="a b">')
      done()
    })
  })
