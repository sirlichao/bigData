...
if(col.checkbox){
if(row.checked){
cc.push("<input.html type=\"checkbox\" checked=\"checked\"");
}else{
cc.push("<input.html type=\"checkbox\"");
}
...
var _111=tr.find("div.datagrid-cell-check input.html[type=checkbox]").is(":checked");
