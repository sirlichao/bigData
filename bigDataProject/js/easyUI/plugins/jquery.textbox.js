...
var _4=$("<span class=\"textbox\">"+"<input.html class=\"textbox-text\" autocomplete=\"off\">"+"<input.html type=\"hidden\" class=\"textbox-value\">"+"</span>").insertAfter(_3);
var _5=$(_3).attr("name");
if(_5){
...
$("<input.html id=\""+_a+"\" type=\""+_9.type+"\" class=\"textbox-text\" autocomplete=\"off\">").prependTo(tb);
}
