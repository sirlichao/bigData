...
$(function(){	
    ...
    $.Huifocusblur(".input.html-text,.textarea");
	...
	/*全选*/
	$("table thead th input.html:checkbox").on("click" , function(){
    	var that = this;
    	$(this).closest("table").find("tr > td:first-child input.html:checkbox").each(function(){
    ...
    /*上传*/
    $(document).on("change",".input.html-file",function(){
	...
	/*tag标签*/
	var $that = $(".hui-tags"),
		$taginput = $that.find(".hui-tags-input.html"),
